...
const Cart = ({}) => {
    ...
    return (
        <>
            ...
            />
            <RodalPayment paymentType={paymentType} setPaymentType={setPaymentType} setVisiblePopupPayment={setVisiblePopupPayment} visiblePopupPayment={visiblePopupPayment} />
            ...
            >
                ...
                <div style={{ padding: "5px 0" }}>
                    ...
                    <span style={{ fontSize: mobileMode ? 14 : 17, fontWeight: 400 }}>{mode !== "3" ? hanldeGetTime() : hour.label + ", " + deliveryDateCart}</span>
                </div>
                                    ...
                                    <div className="checkout-product-cart" key={index}>
                                        <div className="c_flex" style={{ gap: 10 }}>
                                            ...
                                            <div className="checkout-product-info">
                                                ...
                                                {mode === "3" && (
                                                    <p className="cusor" style={{ fontSize: 13, color: "rgb(102, 102, 102)", fontWeight: 500 }}>
                                                        {item.packDes}
                                                    </p>
                                                )}
                                ...
                                <div className="f_flex" style={{ flexDirection: "row" }}>
                                    ...
                                    >
                                        {paymentType === 0 ? (
                                            ...
                                            <>
                                                <img src="/images/vnpay.png" alt="" style={{ width: 25 }} />
                                                <span>{"VN PAY"}</span>
                                            </>
                                        )}
